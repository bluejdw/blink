...
stc_dma_control_blk_t dma_blk __attribute__((section(".ARM.__at_0x20000000"), zero_init));

#elif ((defined __ICCARM__) || (defined __GNUC__) || (defined __clang__))

/** Default DMA control block, 0x20000000 - 0x2000007f (IAR / GCC / CLANG) */
stc_dma_control_blk_t dma_blk __attribute__((section(".ARM.__at_0x20000000")));
