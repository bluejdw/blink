...
#define TIM_BANK_OUT_OF_RANGE (-1)
...
#undef VOR_TIM_BANK
VOR_TIM_Type* const VOR_TIM_BANK[24] = {(VOR_TIM_Type*)VOR_TIM0_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM1_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM2_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM3_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM4_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM5_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM6_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM7_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM8_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM9_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM10_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM11_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM12_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM13_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM14_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM15_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM16_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM17_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM18_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM19_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM20_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM21_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM22_BASE, 
                                        (VOR_TIM_Type*)VOR_TIM23_BASE};
...
static int32_t delayTimerBank = TIM_BANK_OUT_OF_RANGE;
 ...
 **
 ******************************************************************************/
hal_status_t HAL_Timer_SetupPeriodicIrqMs(uint32_t timerNum,  uint32_t periodMsec, uint32_t priority)
{ 
  if(periodMsec == 0) return hal_status_badParam;
  hal_status_t status = HAL_Timer_InitTimer(timerNum, (stc_tim_cfg_t){
                                            .irq_en = true,
                                            .rst_value = ((TIMER_CLK(timerNum)/1000)*periodMsec)-1,
                                            .cnt_value = 0
                                            },
                                            false);
 ...
 **
 ******************************************************************************/
hal_status_t HAL_Timer_SetupPeriodicIrqUs(uint32_t timerNum,  uint32_t periodUsec, uint32_t priority)
{ 
  if(periodUsec == 0) return hal_status_badParam;
  hal_status_t status = HAL_Timer_InitTimer(timerNum, (stc_tim_cfg_t){
                                            .irq_en = true,
                                            .rst_value = ((TIMER_CLK(timerNum)/1000000)*periodUsec)-1,
                                            .cnt_value = 0
                                            },
                                            false);
...
{
  if(timeoutMsec == 0) return hal_status_badParam;
  hal_status_t status = HAL_Timer_InitTimer(timerNum, (stc_tim_cfg_t){
                                            .auto_disable = true,
                                            .rst_value = 0,
                                            .cnt_value = ((TIMER_CLK(timerNum)/1000)*timeoutMsec)-1
                                            },
                                            true);
...
{
  if(timeoutUsec == 0) return hal_status_badParam;
  hal_status_t status = HAL_Timer_InitTimer(timerNum, (stc_tim_cfg_t){
                                            .auto_disable = true,
                                            .rst_value = 0,
                                            .cnt_value = ((TIMER_CLK(timerNum)/1000000)*timeoutUsec)-1
                                            },
                                            true);
...
hal_status_t HAL_Timer_SetDelayTimer(uint32_t timerNum)
{
  ...
  if(false == (timerNum < HAL_NUM_TIMERS)){
    // index out of range
    delayTimerBank = TIM_BANK_OUT_OF_RANGE;
    return hal_status_badParam;
  }
...
hal_status_t HAL_Timer_SetupPWMA(uint32_t timerNum, uint32_t freqHz, percent_1000_t dutyCycle)
{
  ...
  c_assert(0 != freqHz);
  if(0 == freqHz){ return hal_status_badParam; }
  if(freqHz > TIMER_CLK(timerNum)){ return hal_status_badParam; }
  pwma_val = (uint64_t)(TIMER_CLK(timerNum)/freqHz) * (uint64_t)(TIMER_PWM_DUTY_MAX-dutyCycle);
  pwma_val /= (uint64_t)TIMER_PWM_DUTY_MAX;
  status  = HAL_Timer_InitTimer(timerNum, (stc_tim_cfg_t){
                                .status_sel = en_tim_status_sel_pwma,
...
hal_status_t HAL_Timer_SetPWMFreq(uint32_t timerNum, uint32_t freqHz)
{
  ...
  // set frequency
  VOR_TIM_BANK[timerNum]->RST_VALUE = (TIMER_CLK(timerNum)/freqHz)-1;
...
hal_status_t HAL_Timer_SetPWMADutyCycle(uint32_t timerNum, percent_1000_t dutyCycle)
{
  ...
  pwma_val = (uint64_t)(VOR_TIM_BANK[timerNum]->RST_VALUE) * (uint64_t)(TIMER_PWM_DUTY_MAX-dutyCycle);
  pwma_val /= (uint64_t)TIMER_PWM_DUTY_MAX;
