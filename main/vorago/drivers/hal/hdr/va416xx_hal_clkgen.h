...
#define HAL_CLKGEN_VERSION (0x00000402) // 0.4.2

#define PLLOUT_MIN_MHZ     (7)
#define PLLOUT_MAX_MHZ     (100)

/** Common sys clock configuration macros */
#define CLK_CFG_XTAL_N      (hal_clkgen_init_t){.xtalsel = hal_xtalsel_xtal_n_en, \
                                                .clksel = hal_clksel_sys_xtal_n, \
                                                .pllcfg = hal_pllcfg_pwrdn, \
                                                .clk_div_sel = hal_clk_div_1x, \
                                                .lost_det_en = true}

#define CLK_CFG_XTAL_OSC    (hal_clkgen_init_t){.xtalsel = hal_xtalsel_xtal_en, \
...
#define CLK_CFG_XTAL_N_PLL80 (hal_clkgen_init_t){.xtalsel = hal_xtalsel_xtal_n_en, \
...
#define CLK_CFG_X_OSC_PLL80  (hal_clkgen_init_t){.xtalsel = hal_xtalsel_xtal_en, \
                                                .clksel = hal_clksel_sys_pll, \
                                                .pllcfg = hal_pllcfg_enabled, \
                                                .clk_div_sel = hal_clk_div_1x, \
                                                .lost_det_en = true, \
