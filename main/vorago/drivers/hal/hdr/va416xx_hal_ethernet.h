...
#define  MIIADDR_PHY_SPEED        0x2000    // set phy speed bit				* Auto-negotiation must be run -
#define  MIIADDR_PHY_AN           0x1000    // set auto-negotiation bit	*		inorder to make these bit -
#define  MIIADDR_PHY_DUPLEX       0x0100    // set Duplex mode bit			*		take effect on wire
