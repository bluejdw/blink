...
extern hal_status_t HAL_Spi_InitMaster(VOR_SPI_Type* const spi, en_spi_clkmode_t mode, uint8_t wordLen, uint16_t clkDiv);
extern hal_status_t HAL_Spi_InitSlave (VOR_SPI_Type* const spi, en_spi_clkmode_t mode, uint8_t wordLen, uint8_t ss);
...
extern hal_status_t HAL_Spi_XferB16(VOR_SPI_Type* const spi, uint16_t* txBuf, uint16_t* rxBuf, uint16_t len, bool bmstop, uint8_t ss);
extern hal_status_t HAL_Spi_XferB8 (VOR_SPI_Type* const spi, uint8_t* txBuf, uint8_t* rxBuf, uint16_t len, bool bmstop, uint8_t ss);
