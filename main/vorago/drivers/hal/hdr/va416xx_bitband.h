...
#define BITBAND_SRAM(addr,b) ((BITBAND_SRAM_BASE + ((uint32_t)addr - \
                               BITBAND_SRAM_REF) * 32 + (b * 4))) 

// Convert PERIPHERAL address and bit pos to bitband alias address
#define BITBAND_PERI_REF  (0x40000000)
#define BITBAND_PERI_BASE (0x42000000)
#define BITBAND_PERI(addr,b) ((BITBAND_PERI_BASE + ((uint32_t)addr - \
                               BITBAND_PERI_REF) * 32 + (b * 4))) 
