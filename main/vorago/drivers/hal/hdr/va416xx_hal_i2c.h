...
extern hal_status_t HAL_I2CM_Init(VOR_I2C_Type * const i2c, 
                                  stc_i2c_masterInit_t const init);
extern hal_status_t HAL_I2CS_Init(VOR_I2C_Type * const i2c, 
                                  stc_i2c_slaveInit_t const init);
...
extern hal_status_t HAL_I2CM_WriteB(VOR_I2C_Type * const i2c,
                                    i2caddr_shifted_t i2cAddr, 
                                    char *dataPtr, uint32_t len);
extern hal_status_t HAL_I2CM_ReadB(VOR_I2C_Type * const i2c,
                                   i2caddr_shifted_t i2cAddr, 
                                   char *dataPtr, uint32_t len);
extern hal_status_t HAL_I2CM_WrReadB(VOR_I2C_Type * const i2c,
                                     i2caddr_shifted_t i2cAddr, 
...
extern hal_status_t HAL_I2CM_Write(VOR_I2C_Type * const i2c,
                                   i2caddr_shifted_t i2cAddr, 
                                   char *dataPtr, uint32_t len);
extern hal_status_t HAL_I2CM_Read(VOR_I2C_Type * const i2c,
                                  i2caddr_shifted_t i2cAddr, 
                                  char *dataPtr, uint32_t len);
extern hal_status_t HAL_I2CM_WrRead(VOR_I2C_Type * const i2c,
                                    i2caddr_shifted_t i2cAddr, 
                                    char *wrDataPtr, uint32_t wrLen,
                                    char *rdDataPtr, uint32_t rdLen);
...
extern hal_status_t HAL_I2CS_Listen(VOR_I2C_Type * const i2c,
